...
import { Fundraiser_rewards } from "@prisma/client";
import editReward from "../../../app/helpers/projects/rewards/edit";
...
const EditRewardsModal = ({ isOpen, setIsOpen, reward }: Props) => {
  console.log(reward);
  ...
  const initialState: {
    ...
    rewardTitle: reward.rewards_title,
    rewardDescription: reward.rewards_descriprion,
    rewardAmountRequirement: !reward
      ? ""
      : String(reward.rewards_amount_requirement),
    rewardStock: String(reward.rewards_in_stock),
